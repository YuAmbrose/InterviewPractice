...
public class RankListModelImp extends BaseModel implements  RankListModel<RankListBean>{
    ...
    @Override
    public void loadListAuthor(String strategy, String id, int start, int num, final IBaseRequestCallBack<RankListBean> iBaseRequestCallBack) {
        mcompositeDisposable.add(api.getAuthorList(strategy,id,start,num)
                .observeOn(AndroidSchedulers.mainThread())
                .subscribeOn(Schedulers.io())
                .subscribe(new Consumer<RankListBean>() {
                    @Override
    ...
    @Override
    public void loadPopular(String strategy,String  id, int start, int num, final IBaseRequestCallBack<RankListBean> iBaseRequestCallBack) {
        mcompositeDisposable.add(api.getPopular(strategy,id,start,num)
                .observeOn(AndroidSchedulers.mainThread())
                .subscribeOn(Schedulers.io())
                .subscribe(new Consumer<RankListBean>() {
                    @Override
