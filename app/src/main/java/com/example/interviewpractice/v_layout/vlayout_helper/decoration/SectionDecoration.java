package com.example.interviewpractice.v_layout.vlayout_helper.decoration;
...
public class SectionDecoration extends RecyclerView.ItemDecoration {
    ...
    /**
     * @param sectionLayoutId 分组布局id
     */
    public SectionDecoration(@LayoutRes int sectionLayoutId) {
